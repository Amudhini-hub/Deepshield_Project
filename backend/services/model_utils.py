...
class ModelTrainer:
    ...
    @staticmethod
    def compile_deepfake_model(model: keras.Model, learning_rate: float = 0.001) -> None:
    ...
    @staticmethod
    def compile_liveness_model(model: keras.Model, learning_rate: float = 0.001) -> None:
...
def get_model_info() -> Dict:
    ...
    return {
        "deepfake_detection": {
            ...
            "ensemble": True,
            "fallback_methods": ["frequency_analysis", "compression_artifacts", "blend_detection", "face_consistency"]
        },
        "liveness_detection": {
            "models": ["EfficientNetB3"],
            "ensemble": True,
            "detection_methods": ["neural_network", "blink_patterns", "micro_motions", "frequency_patterns", "RPPG"]
        }
    }
