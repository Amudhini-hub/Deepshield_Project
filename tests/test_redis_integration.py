...
class TestRedisManager:
    ...
    def test_session_creation(self):
        ...
        session_id = redis_mgr.create_session("user_1", session_data, expires_in_hours=24)
    ...
    def test_session_retrieval(self):
        ...
        session_id = redis_mgr.create_session("user_2", session_data, expires_in_hours=24)
...
class TestTokenBlacklisting:
    ...
    def test_blacklist_token_via_authentication(self):
        ...
        from backend.services.authentication import blacklist_token, is_token_blacklisted
